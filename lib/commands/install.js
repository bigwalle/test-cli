...
var config = {
    name: 'install',
    explain: "install ecarx platform and components' librarys.",
    command: 'ecarx install',
    options: [{
        keys: ['-h', '--help'],
        describe: 'read help'
    }, {
...
var questions = [{
    type: 'list',
    name: 'platform',
    message: 'You can install or update ecarx sdk and librarys.',
    choices: [{
            name: "ecarx-sdk | ios ",
            value: "runiOSInstallScript"
        }, {
            name: "ecarx-sdk | android",
            value: "runAndroidInstallScript"
        }, {
            name: "ecarx-sdk | ios & android",

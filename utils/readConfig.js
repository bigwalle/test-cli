...
function readAllConfig() {
    var configPath = path.join(process.cwd(), './config.js'),
        erosDevPath = path.join(process.cwd(), './config/ecarx.dev.js'),
        erosConfigPath = path.resolve(process.cwd(), './config/ecarx.native.js');
...
function readNativeConfig() {
    return require(path.resolve(process.cwd(), './config/ecarx.native.js'))
}
